...
app.post("/submit", (req, res) => {
  ...
  // console.log(year);
  const ran1 = Math.floor(Math.random() * adj.length);
  const ran2 = Math.floor(Math.random() * noun.length);
  const geneName = adj[ran1] +" "+  noun[ran2];
  const genName = {
    geneName: geneName,
    y: year,
  }
  res.render("index.ejs", genName);
